...
const SectionTitle = ({ heading, subHeading, textColor, sectionTitle }) => {
  return (
    <div
      className={`flex flex-col justify-center items-center mb-10 md:w-sm w-xs mx-auto ${
        sectionTitle === false && "hidden"
      }`}
    >
