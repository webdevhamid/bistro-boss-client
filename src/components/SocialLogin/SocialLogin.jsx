...
const SocialLogin = () => {
  ...
  const handleGoogle = async () => {
    ...
    // Navigate the user to the desired path
    navigate(from, { replace: true });
  };

  return (
    <div className="flex items-center justify-evenly gap-3 overflow-hidden">
      {/* Google */}
      <button
      ...
      {/* Facebook */}
      <button className="btn bg-[#1A77F2] text-white rounded-full">
        <svg
